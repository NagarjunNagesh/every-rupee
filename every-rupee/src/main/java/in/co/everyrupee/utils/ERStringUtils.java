...
public class ERStringUtils extends StringUtils {
	 ...
	 * @return
	 */
	public static boolean notEqualsIgnoreCase(CharSequence pString, CharSequence pString2) {
	 ...
	 * @return
	 */
	public static boolean notContains(CharSequence seq, CharSequence searchSeq) {
	 ...
	 * @return
	 */
	public static boolean notStartsWith(CharSequence str, CharSequence prefix) {
