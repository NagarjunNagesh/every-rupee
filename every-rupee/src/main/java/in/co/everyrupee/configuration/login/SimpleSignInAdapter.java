...
public final class SimpleSignInAdapter implements SignInAdapter {
	...
	/**
	 * Extending the signin feature to close the new pop up for sign in if the user is already logged in 
	 */
	public String signIn(String userId, Connection<?> connection, NativeWebRequest request) {
		SecurityContext.setCurrentUser(new Profile(userId == null ? 0 : Integer.valueOf(userId)));
