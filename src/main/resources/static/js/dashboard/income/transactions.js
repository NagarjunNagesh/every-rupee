...
$(document).ready(function(){
	...
	document.getElementById('plannedAmountCategoryModal').addEventListener("focusin",function(e){
		userUpdateBudgetCached = trimElement(this.innerText);
	},false);
	
	document.getElementById('plannedAmountCategoryModal').addEventListener("focusout",function(e){
