...
public class UserBudgetController {
	...
	UserBudget userBudgetResponse = userBudgetService.saveAutoGeneratedUserBudget(formData, financialPortfolioId, true);
	...
	List<UserBudget> userBudgetSaved = userBudgetService.updateAutoGeneratedBudget(formData, formFieldName, financialPortfolioId,
		dateMeantFor);
