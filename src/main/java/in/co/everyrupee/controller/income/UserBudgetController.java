...
public class UserBudgetController {
    ...
    public UserBudget updateAutoGeneratedUserBudget(
	    @PathVariable @Size(min = 0, max = GenericConstants.MAX_ALLOWED_LENGTH_FINANCIAL_PORTFOLIO) String financialPortfolioId,
	    @RequestBody MultiValueMap<String, String> formData, Principal userPrincipal) {

	getProfileService().validateUser(userPrincipal, financialPortfolioId);
