...
public class UserBudgetService implements IUserBudgetService {
	...
	List<UserBudget> userBudgetList = userBudgetRepository
		.fetchAutoGeneratedUserBudgetWithCategoryIds(budgetIdsAsIntegerList, pFinancialPortfolioId);
	...
	userBudgetRepository.deleteAutoGeneratedUserBudgetWithCategoryIds(categoryIdsAsIntegerList,
	...
	List<UserBudget> userBudgetList = userBudgetRepository
		.fetchAutoGeneratedUserBudgetWithCategoryIds(categoryIdsAsIntegerList, financialPortfolioId);
