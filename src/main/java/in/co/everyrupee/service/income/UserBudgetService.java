...
public class UserBudgetService implements IUserBudgetService {
	...
	try {
	    ...
	    userBudgetList = userBudgetRepository.fetchUserBudgetWithCategoryIds(budgetIdsAsIntegerList,
	...
	try {
	    ...
	    List<UserBudget> categoryBudget = userBudgetRepository.fetchUserBudgetWithCategoryIds(categoryIds,
		    pFinancialPortfolioId, date);
	...
	try {
	    ...
	    List<UserBudget> userBudgetList = userBudgetRepository
		    .fetchUserBudgetWithCategoryIds(categoryIdsAsIntegerList, financialPortfolioId, date);
